...
public class DynamicBrokersReader {
	...
	public DynamicBrokersReader(Map conf, String zkStr, String zkPath, String topic) {
		_zkPath = zkPath;
		_topic = topic;
		_curator = CuratorFrameworkFactory.newClient(zkStr, Utils.getInt(conf.get(Config.STORM_ZOOKEEPER_SESSION_TIMEOUT)), 15000,
	...
	/**
	 * get /brokers/topics/distributedTopic/partitions/1/state { "controller_epoch":4, "isr":[ 1, 0 ], "leader":1, "leader_epoch":1, "version":1 }
	 *
	 * @param partition
	 * @return
	 */
	...
	/**
	 * [zk: localhost:2181(CONNECTED) 56] get /brokers/ids/0 { "host":"localhost", "jmx_port":9999, "port":9092, "version":1 }
	 *
	 * @param contents
	 * @return
	 */
